type CssModuleObj = Readonly<Record<string, string>>
...
type CssModuleChain<M extends CssModuleObj> = CssModuleClasses<M> & CssModuleOutput & CssModuleFnOutput
type CssModuleCallableChain<M extends CssModuleObj> = CssModuleChain<M> & CssModuleCondition<M>

function chainableClassNames<M extends CssModuleObj>(mod: M): CssModuleClasses<M> {
  const classNames = new Set<string>()
  let latestClassName = ''

  function buildFinalClassName(): string {
  ...
  function conditionFn(condition?: unknown): string | CssModuleChain<M> {
...
export default chainableClassNames
